...
PLATFORM_CXXFLAGS = -I$(PALM_WEBOS_PDK)/include -mcpu=arm1136jf-s -mfpu=vfp -mfloat-abi=softfp -I$(PALM_WEBOS_PDK)/include/SDL --sysroot=$(PALM_WEBOS_PDK)/arm-gcc/sysroot -L$(PALM_WEBOS_PDK)/device/lib -Wl,--allow-shlib-undefined -lSDL -lGLESv2
